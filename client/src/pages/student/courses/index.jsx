...
function StudentViewCoursesPage() {
  ...
  function handleFilterOnChange(sectionId, getCurrentOption) {
    ...
    const indexOfCurrentSeection =
      Object.keys(cpyFilters).indexOf(sectionId);

    console.log(indexOfCurrentSeection, sectionId);
    if (indexOfCurrentSeection === -1) {
      ...
      const indexOfCurrentOption = cpyFilters[sectionId].indexOf(
        getCurrentOption.id
      );

      if (indexOfCurrentOption === -1)
        cpyFilters[sectionId].push(getCurrentOption.id);
      else cpyFilters[sectionId].splice(indexOfCurrentOption, 1);
    }
