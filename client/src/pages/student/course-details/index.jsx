...
// const start = location.pathname.indexOf("67");
// const end = location.pathname.indexOf("37") + 2; // +2 to include "37"

// const result = location.pathname.substring(start, end);
// console.log(result); // Output: "67ced5cc6056b693349cd037"
  ...
  useEffect(() => {
    ...
    // Fetch course details even if the user hasn't purchased it
